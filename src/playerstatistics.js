...
Promise.all([
    ...
    window.initialiseFirstPlayerOnTeamChange = function (selectedTeam, direction) {
        ...
        var initialLeftTest = data[0].filter(function (d) { return d.Team == selectedTeam });
        var maxRating = d3.max(initialLeftTest, function (d) { return + d.Rating; });
        var topPlayer = initialLeftTest.filter(function (d) {
        ...
        console.log("Name", data[0][15].FullName)
        ...
        function updatePlayer(selectedPlayer, check, otherPlayer) {
            ...
            console.log("AUSPROBIEREN selectedTeamPlayer: " + otherPlayerGetColor)
