...
d3.csv("./data/World_cup_2018_players_complete.csv").then(function (data) {
    ...
    var initialLeftTest = data.filter(function (d) { return d.Team == selectedTeam });
    var maxRating = d3.max(initialLeftTest, function(d) { return + d.Rating;} );
    ...
    const widthDomainAssists = d3.extent(data, d => Number(d.Assists));
    ...
    function playerBar(svg, barTitle, barDetails, scorePlayerLeft, scorePlayerRight,
        widthDomain, startXLineRight, startXLineLeft, categoryDescr) {
